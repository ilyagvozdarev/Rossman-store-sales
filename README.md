...
Необходимо спрогнозировать ежедневные продажи на срок до шести недель по данным о магазинах и истории прошлых ежедневных продаж.<br> 
...
Две модели:
- для всех рядов кроме коротких, обучение на всех рядах кроме коротких.
- для коротких рядов, обучение на всех рядах (короткие просемплированы)<br>

Признаки модели:
- столбцы 'Store', 'DayOfWeek', 'Open', 'Promo', 'SchoolHoliday', 'StateHoliday'
- номер дня, недели, месяца, года, дня года
