...
**График запаздывания (lag plot) для лага k** - график, в котором для каждой точки значение по горизонтали - наблюдение ряда, значение по вертикали - предыдущее наблюдение ряда со смещением k.<br><br>
