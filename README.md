...
**График запаздывания (lag plot) для лага k** - график, в котором для каждой точки значение по горизонтали - i-е наблюдение ряда, значение по вертикали - предыдущее наблюдение ряда со смещением k (i-k наблюдение ряда).<br><br>
